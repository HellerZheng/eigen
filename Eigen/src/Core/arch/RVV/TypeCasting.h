...
#ifndef EIGEN_TYPE_CASTING_RVV_H
#define EIGEN_TYPE_CASTING_RVV_H
...
EIGEN_STRONG_INLINE PacketXf pcast<PacketXi, PacketXf>(const PacketXi& a) {
  return __riscv_vfcvt_f_x_v_f32m1(a, EIGEN_RISCV_RVV_VL);
}

template <>
EIGEN_STRONG_INLINE PacketXi pcast<PacketXf, PacketXi>(const PacketXf& a) {
  return __riscv_vfcvt_x_f_v_i32m1(a, EIGEN_RISCV_RVV_VL);
}
...
#endif // EIGEN_TYPE_CASTING_RVV_H
